...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        let visitor_image = Table::create()
            ...
            .col(ColumnDef::new(VisitorImage::ImageId).string().not_null())
            .col(ColumnDef::new(VisitorImage::CompressedImageID).string().not_null())
            .col(ColumnDef::new(VisitorImage::CurrentImageID).string().not_null())
